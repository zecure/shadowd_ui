...
class ParameterFilterType extends AbstractType
{
	public function buildForm(FormBuilderInterface $builder, array $options)
	{
		$builder
			->setMethod('GET')
			->setAction('#')
			->add('parameterId', 'integer', array('required' => false, 'label'  => 'Parameter ID'))
			...
			->add('searchValues', 'bootstrap_collection', array('allow_add' => true, 'allow_delete' => true, 'label' => 'Value'))
			->add('threat', 'checkbox', array('required' => false, 'label' => 'Show threats only'))
			->add('noRule', 'checkbox', array('required' => false, 'label' => 'Show no rule only'))
			->add('brokenRule', 'checkbox', array('required' => false, 'label' => 'Show broken rule only'))
			->add('criticalImpact', 'checkbox', array('required' => false, 'label' => 'Show critical impact only'))
