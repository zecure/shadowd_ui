	...
	$("#generator_settings_predefined").change(function () {
		switch ($(this).val()) {
			case '1': // low security
				...
				$("#generator_settings_minFilterDominance").slider('setValue', 0);
			...
			case '2': // moderate security
				...
				$("#generator_settings_minFilterDominance").slider('setValue', 100);
				$("#generator_settings_maxLengthVariance").val('0');
			...
			case '3': // high security
				$("#generator_settings_enableWhitelist").prop('checked', true);
				$("#generator_settings_minFilterDominance").slider('setValue', 90);
