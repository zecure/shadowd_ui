...
class UserFilterType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->setMethod('GET')
            ->setAction('#')
            ->add('includeUserIds', BootstrapCollectionType::class, ['allow_add' => true, 'allow_delete' => true, 'label' => 'User ID'])
            ->add('includeUsernames', BootstrapCollectionType::class, ['allow_add' => true, 'allow_delete' => true, 'label' => 'Username'])
            ->add('includeEmails', BootstrapCollectionType::class, ['allow_add' => true, 'allow_delete' => true, 'label' => 'Email'])
            ...
            ->add('excludeUserIds', BootstrapCollectionType::class, ['allow_add' => true, 'allow_delete' => true, 'label' => 'User ID'])
            ->add('excludeUsernames', BootstrapCollectionType::class, ['allow_add' => true, 'allow_delete' => true, 'label' => 'Username'])
            ->add('excludeEmails', BootstrapCollectionType::class, ['allow_add' => true, 'allow_delete' => true, 'label' => 'Email'])
