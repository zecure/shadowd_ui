...
class WhitelistRuleType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('caller')
            ->add('path')
            ->add('minLength', null, ['required' => false, 'empty_data' => '-1', 'label' => 'Min. length'])
            ->add('maxLength', null, ['required' => false, 'empty_data' => '-1', 'label' => 'Max. length'])
            ->add('filter', EntityType::class, ['property' => 'getDescription', 'class' => 'SwdAnalyzerBundle:WhitelistFilter',
