...
{
    public function findAllFiltered(BlacklistRuleFilter $filter)
    {
    ...
    public function findAllByRule(BlacklistRule $rule)
    {
    ...
    public function findAllByExport(BlacklistExport $filter)
    {
        $builder = $this->createQueryBuilder('br')
