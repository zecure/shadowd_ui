...
{
    public function findAllFiltered(IntegrityRuleFilter $filter)
    {
    ...
    public function findAllByRule(IntegrityRule $rule)
    {
    ...
    public function findAllByExport(IntegrityExport $filter)
    {
        $builder = $this->createQueryBuilder('ir')
