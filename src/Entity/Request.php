...
class Request
{
    ...
    public function addBrokenIntegrityRule(IntegrityRule $brokenRules)
    {
    ...
    public function removeBrokenIntegrityRule(IntegrityRule $brokenRules)
    {
    ...
    public function removeHash(Hash $hash)
    {
