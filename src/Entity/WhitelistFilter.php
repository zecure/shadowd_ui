 ...
 * @ORM\Entity(repositoryClass="App\Repository\WhitelistFilterRepository")
 */
class WhitelistFilter
{
    ...
    public function addRule(WhitelistRule $rules)
    {
        $this->rules[] = $rules;
    ...
    public function removeRule(WhitelistRule $rules)
    {
