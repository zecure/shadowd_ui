...
class Parameter
{
    ...
    public function addBrokenWhitelistRule(WhitelistRule $brokenRules)
    {
    ...
    public function removeBrokenWhitelistRule(WhitelistRule $brokenRules)
    {
    ...
    public function addMatchingBlacklistFilter(BlacklistFilter $matchingFilters)
    {
    ...
    public function removeMatchingBlacklistFilter(BlacklistFilter $matchingFilters)
    {
