...
use App\Form\Type\WhitelistRuleFilterType;
use App\Entity\WhitelistRuleFilter;
use App\Form\Type\WhitelistRuleType;
use App\Entity\WhitelistRule;
use App\Form\Type\WhitelistRuleSelectorType;
use App\Entity\Selector;
use App\Entity\WhitelistImport;
use App\Form\Type\WhitelistImportType;
use App\Entity\WhitelistExport;
use App\Form\Type\WhitelistExportType;

class WhitelistController extends AbstractController
{
    /**
     * @Route("/whitelist/rules", name="swd_analyzer_whitelist_rules")
     */
    public function listAction(Request $request)
    {
        ...
        $form = $this->createForm(WhitelistRuleFilterType::class, $filter);
    ...
    /**
     * @Route("/whitelist/rule", name="swd_analyzer_whitelist_add_rule")
    ...
    public function addAction(Request $request)
    {
        ...
        $form = $this->createForm(WhitelistRuleType::class, $rule);
        $form->handleRequest($request);
    ...
    /**
     * @Route("/whitelist/rule/{id}", name="swd_analyzer_whitelist_edit_rule")
     * @Security("has_role('ROLE_ADMIN')")
     */
    ...
    /**
     * @Route("/whitelist/import", name="swd_analyzer_whitelist_import")
     * @Security("has_role('ROLE_ADMIN')")
     */
    public function importAction(Request $request)
    {
        ...
        $form = $this->createForm(WhitelistImportType::class, $import);
        $form->handleRequest($request);
    ...
    /**
     * @Route("/whitelist/export", name="swd_analyzer_whitelist_export")
     * @Security("has_role('ROLE_ADMIN')")
     */
    public function exportAction(Request $request)
    {
        ...
        $form = $this->createForm(WhitelistExportType::class, $export);
        $form->handleRequest($request);
