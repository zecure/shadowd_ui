...
if [ -z "$SHADOWD_MAILER_TRANSPORT" ]; then
    SHADOWD_MAILER_TRANSPORT="sendmail"
fi
if [ -z "$SHADOWD_MAILER_FROM" ]; then
    SHADOWD_MAILER_FROM="noreply@zecure.org"
fi
...
sed -i "s/PLACEHOLDER_MAILER_TRANSPORT/$SHADOWD_MAILER_TRANSPORT/g" "$SHADOWD_UI_CONFIG"
sed -i "s/PLACEHOLDER_MAILER_HOST/$SHADOWD_MAILER_HOST/g" "$SHADOWD_UI_CONFIG"
sed -i "s/PLACEHOLDER_MAILER_PORT/$SHADOWD_MAILER_PORT/g" "$SHADOWD_UI_CONFIG"
sed -i "s/PLACEHOLDER_MAILER_ENCRYPTION/$SHADOWD_MAILER_ENCRYPTION/g" "$SHADOWD_UI_CONFIG"
sed -i "s/PLACEHOLDER_MAILER_AUTH_MODE/$SHADOWD_MAILER_AUTH_MODE/g" "$SHADOWD_UI_CONFIG"
sed -i "s/PLACEHOLDER_MAILER_USER/$SHADOWD_MAILER_USER/g" "$SHADOWD_UI_CONFIG"
sed -i "s/PLACEHOLDER_MAILER_PASSWORD/$SHADOWD_MAILER_PASSWORD/g" "$SHADOWD_UI_CONFIG"
sed -i "s/PLACEHOLDER_MAILER_FROM/$SHADOWD_MAILER_FROM/g" "$SHADOWD_UI_CONFIG"
